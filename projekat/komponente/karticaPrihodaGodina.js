...
export default function KarticaPrihodaGodina({route,navigation}) {
  
    const {godina} = route.params;
    ...
    async function ucitajKarticu(){
        try{
          ...
          fetch('https://reactprojekat.herokuapp.com/selectKarticaPrihodaGodina/'+godina)      
    ...
    <View style={styles.container}>
      <Text style = {{fontSize: 18}}>Prihodi za godinu : {godina}</Text>
